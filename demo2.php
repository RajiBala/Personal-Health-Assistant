...
<br><br><br><br><br>
<div class="col-md-12">
	<a href="http:www.donateanorgan.com/" target="_black"><button id="myButton1" type="button" class="btn btn-default">DONATE ORGAN</button></a>
</div>
<br><br><br><br><br>
<div class="col-md-12">
...
<br><br><br><br><br>
<div class="col-md-12">
	<button id="myButton3" type="button" class="btn btn-default">VIEW HISTORY</button>
</div>
<br><br><br><br><br>
<div class="col-md-12">
